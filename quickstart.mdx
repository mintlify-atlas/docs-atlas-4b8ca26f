---
title: "Quickstart: Your First Lean 4 Proof with Mathlib"
sidebarTitle: "Quickstart"
description: "Write and run your first Lean 4 proof using Mathlib in minutes. Covers ring, linarith, and norm_num with real working examples."
---
...
#check Real.sqrt_two_mul_self
-- Real.sqrt_two_mul_self : √2 * √2 = 2
```
