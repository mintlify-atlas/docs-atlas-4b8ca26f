...
When a piece of code needs to change because of an upstream Lean or Batteries update, use the `adaptation_note` comment to explain the situation:
...
This helps future contributors understand why the code looks the way it does and makes it easier to clean up after the upstream issue is resolved.
